...
(window.STUDY_DATA = window.STUDY_DATA || []).push(
  ...
  {
    id:'tgweb-x08', cat:'spi-num', topic:'図形（面積差）', diff:2, type:'num',
  ...
  {
    id:'tgweb-x09', cat:'spi-num', topic:'図形（角度）', diff:1, type:'num',
  ...
  {
    id:'tgweb-x13', cat:'spi-num', topic:'新型計数（文章題）', diff:2, type:'num',
