...
- **ピン留め復習（タイミング提示つき）**: PROGRIT でピン留めした「分からなかった問題」の数とメモを
  レッスンごとに記録。ピンは本体レッスンより短い独自スケジュール（1→2→4→8→16→30日）で復習を提案し、
  各レッスンの「今日復習 / 次回◯日後」を専用セクションに表示。「✓ 復習した」で次回へ繰り延べ、
  通しの復習でもピン予定が進む。ピンを0にすると終了。
